...
class OnlineSalesRegisterCollector:
    ...
    def total_tax(self):
        total_twenty_percent = self.twenty_percent_tax_calculation()
        total_ten_percent = self.ten_percent_tax_calculation()
        return total_twenty_percent + total_ten_percent
